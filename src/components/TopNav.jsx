        ...
        <div className="">
            <nav className="navbar navbar-expand-lg bg-white border-bottom">
                <div className="container-fluid">
                    <div className="row   align-items-center">
                        ...
                        <div className="col-2 col-lg-4 mb-2">
                            <button className="btn border-0" onClick={toggle}>
                                <BiMenuAltLeft className="tw-h-12 tw-w-8"/>
                            </button>
                        </div>
                        <div className="col-3 mb-2"><a className="navbar-brand tw-text-xl tw-font-bold" href="#">POS App</a></div>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title className="mx-3">Change Password</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <PasswordForm setShow={setShow}/>
                </Modal.Body>
            </Modal>
        </div>
    );
